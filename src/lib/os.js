...
Object.observe ||
    (function(O, A, root, _undefined) {
        ...
        var isArray =
             ...
             */
            createMap =
                root.Map === _undefined || !Map.prototype.forEach
                    ? function() {
                ...
                return (
                    (data && data.notifier) || {
                        ...
                        performChange: function(
                            ...
                            data &&
                                performPropertyChecks(data, object, changeType);
        ...
        O.observe = function observe(object, handler, acceptList) {
            ...
            if (typeof handler !== 'function')
                throw new TypeError(
                    'Object.observe cannot deliver to non-function',
                );
            ...
            if (acceptList === _undefined) acceptList = defaultAcceptList;
        ...
        O.unobserve = function unobserve(object, handler) {
            if (
                ...
                throw new TypeError(
                    'Object.unobserve cannot unobserve non-object',
                );

            if (typeof handler !== 'function')
                throw new TypeError(
                    'Object.unobserve cannot deliver to non-function',
                );
        ...
        O.getNotifier = function getNotifier(object) {
            if (
                ...
                throw new TypeError(
                    'Object.getNotifier cannot getNotifier non-object',
                );
